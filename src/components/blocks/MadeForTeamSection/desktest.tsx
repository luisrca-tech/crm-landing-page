...
export function DesktopSectionView() {
  return (
    <div className="mt-8 grid grid-cols-2 grid-rows-2 gap-8">
      <SectionsBoxes
        rootClassName="md:max-h-[420px] lg:max-h-[579px]"
        internalClassName="flex flex-col gap-14"
      >
      ...
      <SectionsBoxes
        rootClassName="md:max-h-[420px] lg:max-h-[579px]"
        internalClassName="flex flex-col justify-between gap-10"
      >
      ...
      <SectionsBoxes
        rootClassName="md:max-h-[420px] lg:max-h-[579px]"
        internalClassName="flex flex-col gap-10"
      >
