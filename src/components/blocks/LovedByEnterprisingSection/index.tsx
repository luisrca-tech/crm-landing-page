  ...
  return (
    <div className="flex w-full flex-col">
      <div className="flex flex-col gap-4 pt-10 lg:pt-20">
        ...
        <p className="lg:max-w-[510px] md:text-center lg:text-start text-lg font-normal tracking-[-0.2px] text-base-200 md:text-[22px] md:leading-8 md:tracking-[-0.3px] lg:text-[22px] lg:leading-8 lg:tracking-[-0.3px]">
