    ...
    <footer>
      <div className="relative flex flex-col gap-10 pt-10">
        <div className="flex items-center justify-between">
          ...
          <div className="flex h-5 gap-3 lg:hidden">
            <Image width={10} src={TwitterFooter} alt="Twitter Logo" />
            <Image width={10} src={Dribbble} alt="Dribbble Logo" />
            <Image width={10} src={Linkedin} alt="Linkedin Logo" />
          </div>
        </div>
        <AccordionMobile />
